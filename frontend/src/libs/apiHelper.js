export const rootUrl = location.hostname === 'universalgames.buk.no' ? 'https://universalgames.buk.no/api/' : `https://buk-universal-games-directus-prod-lo75nlp2va-ez.a.run.app/`
