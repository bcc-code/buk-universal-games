<template>
    <section class="bg-vanilla hover:bg-ice-blue rounded-md flex items-center py-3 px-5">
      <img class="h-10 w-10 mr-7" :src="`icon/game-${gameType.replace(/_/g, '')}.svg`" />
...
const gameslistitem = cva("gameslistitem", {
  ...
  compoundVariants: [
    { result: false, twoteams: false, passed: false },
  ],
});
