<template>
  <UserPageLayout :showTitle="false">
    ...
    <section>
      ...
      <MatchListItem v-if="match" :key="match.id" :gameType="getGameById(match.gameId)?.gameType"
        :gameAddOn="match.addOn" :team1="match.team1" :team2="match.team2" :team1result="match.team1Result"
        :team2result="match.team2Result" :start="match.start" :winner="match.winner"
        />
    </section>
  </UserPageLayout>
</template>
