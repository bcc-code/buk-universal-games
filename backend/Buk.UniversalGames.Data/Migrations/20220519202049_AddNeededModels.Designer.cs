...
namespace Buk.UniversalGames.Api.Migrations
{
    ...
    [Migration("20220519202049_AddNeededModels")]
    partial class AddNeededModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Game", b =>
                {
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.League", b =>
                {
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Match", b =>
                {
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Point", b =>
                {
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Sticker", b =>
                {
                    b.Property<int>("StickerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.StickerScan", b =>
                {
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Match", b =>
                {
                    b.HasOne("Buk.UniversalGames.Api.Game", "Game")
                        .WithMany()
                    ...
                    b.HasOne("Buk.UniversalGames.Api.Team", "Team1Team")
                        .WithMany()
                    ...
                    b.HasOne("Buk.UniversalGames.Api.Team", "Team2Team")
                        .WithMany()
                    ...
                    b.HasOne("Buk.UniversalGames.Api.Team", "WinnerTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Point", b =>
                {
                    ...
                    b.HasOne("Buk.UniversalGames.Api.Match", "Match")
                        .WithMany()
                        .HasForeignKey("MatchId")
                        .HasConstraintName("fk_points_matches_match_id");

                    b.HasOne("Buk.UniversalGames.Api.Sticker", "Sticker")
                        .WithMany()
                        .HasForeignKey("StickerId")
                        .HasConstraintName("fk_points_stickers_sticker_id");

                    b.HasOne("Buk.UniversalGames.Api.Team", "Team")
                        .WithMany("Points")
            ...
            modelBuilder.Entity("Buk.UniversalGames.Api.Sticker", b =>
                {
                    b.HasOne("Buk.UniversalGames.Api.League", "League")
                        .WithMany("Stickers")
