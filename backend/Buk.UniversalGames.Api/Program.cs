...
builder.Services.AddDbContext<DataContext>(options =>
{
    ...
    var dataSourceBuilder = new Npgsql.NpgsqlDataSourceBuilder($"Host={dbHost}{(dbPort != "5432" ? ";Port=" + (dbPort ?? "") : "")};Database={dbName};Username={dbUser};Password={dbPassword};Connection Idle Lifetime=3;Pooling=false;Maximum Pool Size=40;Server Compatibility Mode=NoTypeLoading");
    dataSourceBuilder
        .MapEnum<GameType>()
        .MapEnum<TeamType>();
