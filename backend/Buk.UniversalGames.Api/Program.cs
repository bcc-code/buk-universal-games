...
builder.Services.AddDbContext<DataContext>(options =>
{
    ...
    var dataSourceBuilder = new Npgsql.NpgsqlDataSourceBuilder($"Host={dbHost}{(dbPort != "5432" ? ";Port=" + (dbPort ?? "") : "")};Database={dbName};Username={dbUser};Password={dbPassword};Pooling=false;");
    dataSourceBuilder
        .MapEnum<GameType>()
        .MapEnum<TeamType>();
